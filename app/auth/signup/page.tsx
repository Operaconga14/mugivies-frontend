...
export default function Page() {
  ...
  const [alertColor, setAlertColor] = useState("bg-blue-800");
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // TODO: Handle response, maybe show alert
    if (response.message && response.message !== "Signup successful") {
      setAlert(true);
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-start space-x-3">
                  <input
                    ...
                    name="agreeToTerms"
                    required
                    className="mt-1 w-4 h-4 rounded border-gray-600 bg-gray-900/50 text-purple-500 focus:ring-2 focus:ring-purple-500"
                  />
                  <label
