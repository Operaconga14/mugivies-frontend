		...
		<div className={cn("flex gap-4 px-4 py-6 animate-fade-in", isUser ? "bg-message-user" : "bg-message-ai")}>
			...
			<div className="flex-1 min-w-0">
				...
				{isLoading ? (
					...
					<div className="text-foreground/90 whitespace-pre-wrap leading-relaxed">{content}</div>
				) : (
					<div className="prose prose-sm prose-invert max-w-none text-foreground/90 leading-relaxed">
						<ReactMarkdown
							components={{
								...
								code: ({ children }) => <code className="bg-secondary/50 px-1.5 py-0.5 rounded text-primary font-mono text-sm">{children}</code>,
